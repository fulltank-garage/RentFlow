    ...
    <>
      {Array.from({ length: rows }).map((_, index) => (
        ...
        >
          ...
          >
            <Stack spacing={1.75} className="w-full min-w-0 flex-1">
              <Line width="32%" height={18} />
              <Line width="58%" height={14} />
              <Line width="44%" height={14} />
            </Stack>
            <Stack direction="row" spacing={1.5} className="w-full md:w-auto">
        ...
        >
          ...
          >
            <Stack direction={{ xs: "column", sm: "row" }} spacing={2} className="w-full min-w-0 flex-1">
              ...
              <Stack spacing={1.75} className="min-w-0 flex-1">
            ...
            <Stack spacing={1.5} className="w-full md:w-28">
              <Line height={46} />
              <Line height={46} />
            </Stack>
          </Stack>
